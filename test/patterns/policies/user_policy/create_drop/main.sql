...
select has_rls('public', 'c_select'::name);
...
select has_rls('public', 'c_insert'::name);
...
select has_rls('public', 'c_update'::name);
...
select has_rls('public', 'c_delete'::name);
...
select has_rls('public', 'c_all'::name);
